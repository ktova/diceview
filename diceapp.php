...
json_encode ($cleanjson1, JSON_FORCE_OBJECT);
echo 'Données stastiques des prévisions approximatives pour les occurences de n jusqua n+x :<br>';
print_r ($cleanjson1);
...
echo '<br>Données stastiques des prévisions approximatives pour les probabilités que r soit > n :<br>';
print_r ($cleanjson2);
